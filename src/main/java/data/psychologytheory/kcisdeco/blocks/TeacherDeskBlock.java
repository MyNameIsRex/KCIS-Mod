...
public class TeacherDeskBlock extends HorizontalFacingBlock
{
    public static final MapCodec<TeacherDeskBlock> CODEC = createCodec(TeacherDeskBlock::new);
    ...
    public TeacherDeskBlock(Settings settings)
    {
        super(settings);
